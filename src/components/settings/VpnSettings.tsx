...
const EnumSubSection = ({ enumKey, enumLabel, enumerations, setModal, toggleEnumDeletedStatus, renderEnumImportExportDropdown }) => {
    ...
    const hasColor = false; // None of these enums have colors for now.
...
export const VpnSettings = (props) => {
    return html`
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            <div class="settings-section">
                <div class="settings-header" style="padding-bottom: 0;">
                    <h3 style="font-size: 1.25rem;">L2VPN Settings</h3>
                </div>
                <div style="display: flex; flex-direction: column; gap: 1rem; padding: 0 1rem 1rem 1rem;">
                    <${EnumSubSection} ...${props} enumKey="l2VpnEncapsulation" enumLabel="Encapsulation" />
                    <${EnumSubSection} ...${props} enumKey="l2VpnMode" enumLabel="Mode" />
                    <${EnumSubSection} ...${props} enumKey="l2VpnSignalization" enumLabel="Signalization" />
                </div>
            </div>
            <div class="settings-section">
                <div class="settings-header" style="padding-bottom: 0;">
                    <h3 style="font-size: 1.25rem;">L3VPN Settings</h3>
                </div>
                <div style="display: flex; flex-direction: column; gap: 1rem; padding: 0 1rem 1rem 1rem;">
